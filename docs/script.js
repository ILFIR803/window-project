...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    //       if (document.querySelectorAll('.form_input') === '') {
    //          setTimeout(function () {
    //             modal.style.display = 'none';
    //             document.body.style.overflow = '';
    //          }, 60000)
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // showModalBiTime('.popup', 60000);
};
...
var tabs = function tabs(headerSeclector, tabSelector, contentSelector, activeClass) {
  var display = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
  var header = document.querySelector(headerSeclector),
